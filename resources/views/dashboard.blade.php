...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('templ/src/assets/images/favicon_io/apple-touch-icon.png') }}">
  <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('templ/src/assets/images/favicon_io/favicon-32x32.png') }}">
  <link rel="icon" type="{{ asset('templ/src/assets/image/png') }}" sizes="16x16" href="{{ asset('templ/src/assets/images/favicon_io/favicon-16x16.png') }}">
  <link rel="manifest" href="{{ asset('templ/src/assets/images/favicon_io/site.webmanifest') }}">
</head>
...
<footer class="text-center py-2 mt-6 text-secondary ">
  ...
  <!-- Bootstrap JS -->
  <script src="{{ asset('templ/src/assets/js/main.js')  }}"></script>
