<div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<img src="{{ asset('load/images/profile/pic1.jpg') }}" width="20" alt="">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Human Capital</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('profil') }}">Profil</a></li>
                            <li><a href="chart-morris.html">Cuti</a></li>
				...
				<div class="copyright">
					<p><strong>Si Andika - APP</strong> © 2026 All Rights Reserved</p>
					<p class="fs-12">by SONNN7HOTANG</p>
				</div>
			</div>
        </div>